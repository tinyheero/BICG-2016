...
The array data for HCC1143 has already been downloaded for you.  Create a directory and copy the array data to your workspace.

```
mkdir -p data/cel
cp /home/ubuntu/CourseData/CG_data/Module5/data/cel/*.CEL data/cel
```
